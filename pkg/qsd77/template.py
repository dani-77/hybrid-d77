...
# which this project doesn't ship. Needs quickshell (`qs`) at runtime,
# listed in mklive-image.sh's niri set rather than as depends= (same
# convention as utumno's own template).
pkgname = "qsd77"
pkgver = "1.3.3"
pkgrel = 0
build_style = "go"
